...
>>>>>>> 4f81105122a64fbd20998364af96e4680c77703c
...
def writing_gamedata(cur, conn):
    ...
    for game in game_dict:
        if item[0] in team_stadium_dict and count < 26:
            ...
            int(game.get('stadium_id')), game.get('away_team_id')))
