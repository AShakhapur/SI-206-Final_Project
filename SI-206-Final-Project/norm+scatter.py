...
def visualize_scatter(sorted_teams, normalized):
    top_ten = []
    norm_ten = {}
    count = 1
    ...
    layout = go.Layout(title = go.layout.Title(text='Normalized Score data for top 10 teams',xref='paper',x = 0,),
...
#processed = visualize_scatter(sorted_soccer, normalized_soc)
#processed = visualize_scatter(sorted_basketball, normalized_bask)
processed = visualize_scatter(sorted_hockey, normalized_hock)
